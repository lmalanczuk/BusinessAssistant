...
//    private static final String ZOOM_SCOPES = "user:read meeting:read meeting:write recording:read";
//
...
//public ResponseEntity<ApiResponse> oauthCallback(
...
//        if (error != null) {
//            String errorMsg = error_description != null ?
//                error + ": " + error_description : error;
//            logger.error("OAuth error received: {}", errorMsg);
//            return ResponseEntity
//                .status(HttpStatus.BAD_REQUEST)
//                .body(new ApiResponse(false, "Wystąpił błąd podczas autoryzacji z Zoom: " + errorMsg));
//        }
//
//        // Sprawdź czy code jest dostępny
//        if (code == null || code.isEmpty()) {
//            logger.error("No authorization code received in callback");
//            return ResponseEntity
//                .status(HttpStatus.BAD_REQUEST)
//                .body(new ApiResponse(false, "Brak kodu autoryzacji w odpowiedzi Zoom"));
//        }
//
//        logger.info("Received OAuth callback with code and state: {}",
//            state != null ? state.substring(0, Math.min(10, state.length())) + "..." : "null");
//
